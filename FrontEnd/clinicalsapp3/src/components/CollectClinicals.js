...
function CollectClinicals(){
    ...
    useEffect(()=>{
        axios.get("http://localhost:8082/clinicalservices/api/patients/"+patientId).then((res)=>{
    ...
    const handleSubmit=(event)=>{
        ...
        axios.post("http://localhost:8082/clinicalservices/api/clinicals/",data).then((res)=>{
